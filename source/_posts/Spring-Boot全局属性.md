...
categories:
  - Java
date: 2019-12-23 09:58:14
password:
summary:
---

<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=100% height=86 src="//music.163.com/outchain/player?type=2&id=547614214&auto=1&height=66"></iframe>
# Spring Boot全局配置属性参考

在写Spring Boot的时候经常需要写全局配置文件,配置内容很多,这个时候我们就需要一些参考,如下是我整理的关于Spring Boot全局配置的代码,你可以ctrl + F直接查找你需要的;
